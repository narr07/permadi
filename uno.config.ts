...
export default defineConfig({
	...
	shortcuts: {
		...
		'swiss-lead-8': 'col-span-1 sm:grid-cols-6 lg:col-span-8 p-6 sm:p-8 border border-brand-800 dark:border-[#134e43] bg-white dark:bg-[#002b27]',
		'swiss-rail-4': 'col-span-1 sm:col-span-6 lg:col-span-4 p-6 sm:p-8 border border-brand-800 dark:border-[#134e43] bg-white dark:bg-[#002b27] flex flex-col justify-between',
		'swiss-card-flat': 'border border-brand-800 dark:border-[#134e43] bg-white dark:bg-[#002b27] p-6',
		'swiss-card-interactive': 'border border-brand-800 dark:border-[#134e43] bg-white dark:bg-[#002b27] p-6 hover:border-brand-500 transition-colors',
		...
		'swiss-hairline-b': 'border-b border-brand-800 dark:border-[#134e43]',
		'swiss-hairline-t': 'border-t border-brand-800 dark:border-[#134e43]',
		'swiss-hairline-r': 'border-r border-brand-800 dark:border-[#134e43]',
