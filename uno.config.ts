...
export default defineConfig({
	...
	shortcuts: {
		...
		'heading-page': 'font-heading font-800 text-3xl sm:text-5xl lg:text-6xl tracking-tight text-[#000b07] dark:text-[#f8fafa] leading-[1.05] mb-3',
		'heading-page-sub': 'text-[#000b07]/80 dark:text-[#f8fafa]/80 text-base sm:text-lg leading-relaxed max-w-xl',

		'heading-hero': 'font-heading font-800 mb-4 text-4xl sm:text-6xl leading-[0.95] tracking-tight text-[#000b07] dark:text-[#f8fafa]',
		'heading-sub': 'text-[#000b07]/80 dark:text-[#f8fafa]/80 text-base sm:text-lg leading-relaxed max-w-xl',
		'heading-card-lg': 'font-heading font-800 text-xl tracking-tight text-[#000b07] dark:text-[#f8fafa]',
		'heading-card-md': 'font-heading font-800 text-lg text-[#000b07] dark:text-[#f8fafa]',
