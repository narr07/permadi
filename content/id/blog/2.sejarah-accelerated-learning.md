...
Pembelajaran cepat (*accelerated learning*) kerap dianggap sebagai tren belajar baru. Padahal, akarnya tertanam kuat dalam riset psikologi kognitif dan neurosains yang telah berjalan lebih dari setengah abad.

Metode ini lahir sebagai kritik terhadap sistem pengajaran klasikal yang kaku, saat siswa dipaksa menghafal secara pasif dalam tekanan. Melalui pendekatan multisensori dan pemahaman cara kerja alami otak, *accelerated learning* membuktikan bahwa proses belajar bisa berlangsung jauh lebih cepat tanpa mengorbankan kedalaman pemahaman.
...
![Sejarah penerapan awal accelerated learning di ruang kelas](/article/jadul.webp)
...
::faq
  :::faq-item{question="Siapa penemu asli metode Accelerated Learning?"}
  ...
  :::faq-item{question="Apa itu Suggestopedia?"}
  ...
  :::faq-item
  ---
  question: Mengapa musik Barok sering dikaitkan dengan sejarah metode ini?
  ---
  ...
  :::faq-item{question="Kapan metode ini mulai populer di dunia korporat?"}
  *Accelerated learning* mulai diadopsi secara luas oleh para pelatih perusahaan (corporate trainers) di Amerika Serikat dan Eropa pada akhir 1970-an hingga 1980-an sebagai cara untuk menghemat biaya dan waktu pelatihan karyawan.
  ...
  :::faq-item
  ---
  question: Apa perbedaan konsep tahun 1960-an dengan Accelerated Learning saat ini?
  ---
