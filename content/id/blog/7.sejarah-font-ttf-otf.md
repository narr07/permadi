...
## Asal-Usul Huruf Digital: Dari Formula Matematika Menuju Layar

Ketajaman teks di layar komputer hari ini lahir dari perang standar teknologi tipografi pada era 1980-an hingga 1990-an. Persaingan antara Apple, Microsoft, dan Adobe mengubah rupa huruf dari susunan piksel kasar (*bitmap*) menjadi kurva vektor matematis yang kini kita kenal sebagai TrueType (TTF) dan OpenType (OTF).

Memahami perbedaan kedua format ini bukan sekadar bernostalgia dengan sejarah komputasi, melainkan bekal praktis untuk menentukan format berkas yang tepat untuk kebutuhan cetak presisi maupun kecepatan antarmuka web.
...
- **Pilihlah TTF:** Jika Anda hanya butuh font untuk pengetikan dokumen biasa, tugas sekolah, atau presentasi di PowerPoint. Selain ringan, TTF 100% kompatibel dengan semua komputer.
- **Pilihlah OTF:** Jika Anda adalah seorang desainer grafis, UI/UX *designer*, atau pembuat tata letak buku. Fitur ekstra di dalam OTF akan sangat membantu Anda menciptakan karya visual yang jauh lebih profesional dan kaya akan estetika.
::

::faq
  :::faq-item
  ---
  question: Apakah sejarah font TTF dan OTF berarti font lain sudah tidak digunakan?
  ---
  ...
  :::faq-item
  ---
  question: Bisakah saya menginstal font TTF dan OTF secara bersamaan?
  ---
  ...
  :::faq-item{question="Manakah yang lebih tua, TTF atau OTF?"}
  ...
  :::faq-item{question="Mengapa desainer logo lebih menyukai format OTF?"}
  ...
  :::faq-item
  ---
  question: Bagaimana cara mengubah file TTF menjadi OTF atau sebaliknya?
  ---
