...
::faq
  :::faq-item
  ---
  question: So, is it acceptable to call it the 'Accelerated Learning Method'?
  ---
  ...
  :::faq-item
  ---
  question: What is the difference between the Accelerated Learning Approach and
  ...
  *Accelerated learning* is the philosophy or the grand approach, whereas SAVI (*Somatic, Auditory, Visual, Intellectual*) is one concrete "Learning Model" created by Dave Meier to practice that *accelerated learning* philosophy in the classroom.
  ...
  :::faq-item
  ---
  question: Can Accelerated Learning be combined with the Problem-Based Learning
    (PBL) Model?
  ---
  ...
  :::faq-item
  ---
  question: If I only use mind mapping in class, have I applied accelerated learning?
  ---
  ...
  :::faq-item
  ---
  question: Why is it important for teachers to distinguish between the terms
