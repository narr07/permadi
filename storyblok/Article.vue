<template>
  <div class="py-16">
      ...
      <div class="max-w-2xl">
        <div class="space-y-5 md:space-y-8">
          <UCard
            ...
            <h1 class="text-g2 md:text-g3 my-2 bg-red">
              {{ blok.title }}
            </h1>
          ...
          <UCard>
            ...
            class="prose prose-permadi prose-blockquote:font-normal prose-headings:text-permadi-800 prose-blockquote:border-l-permadi dark:prose-blockquote:border-l-yellow max-w-3xl mx-auto  dark:prose-invert "></div>
          </UCard>
        </div>
        <!-- End Content -->
      </div>
    ...
    <!-- End Sticky Share Group -->  </UContainer>
  </div>
</template>
<script setup>
