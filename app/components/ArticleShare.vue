...
<template>
	...
	<div
		...
		class="relative border border-slate-200/80 bg-white p-3.5 shadow-sm dark:border-[#134e43] dark:bg-[#002b27] sm:p-4"
	>
		<div class="mb-2.5 flex items-center justify-between gap-2 border-b border-slate-200/60 pb-2 dark:border-slate-800/60">
			...
			<button
				type="button"
				class="inline-flex cursor-pointer items-center gap-1.5 border border-slate-200/70 bg-slate-100/90 px-2 py-1 text-[10px] text-slate-700 font-semibold transition-all duration-200 dark:border-[#134e43] dark:bg-[#042f27] hover:bg-white dark:text-slate-200 dark:hover:bg-[#073d32]"
		...
		<div class="grid grid-cols-6 gap-1.5">
			<SocialShare
				...
				user="dinarpermadi07"
				class="group aspect-square flex items-center justify-center border border-slate-200/70 bg-slate-50 p-1 text-slate-700 transition-all duration-200 dark:border-[#134e43]/90 dark:bg-[#002420]/80 hover:bg-white dark:text-slate-300 dark:hover:bg-[#003833]"
	...
	<!-- 2. Standard Default Wide Swiss Variant -->
	<aside
		v-else
		aria-label="Social Share"
		class="relative my-12 border border-slate-200/80 bg-white/90 p-6 shadow-sm dark:border-[#134e43] dark:bg-[#002b27]/90 sm:p-7"
	>
		...
		<div class="mb-6 flex flex-col justify-between gap-3 border-b border-slate-200/60 pb-4 sm:flex-row sm:items-center dark:border-slate-800/60">
			<div>
				<div class="mb-2 inline-flex items-center gap-1.5 border border-brand-200/60 bg-brand-100/80 px-2.5 py-0.5 text-[11px] text-brand-800 font-semibold tracking-wider uppercase dark:border-brand-800/60 dark:bg-brand-950 dark:text-brand-300">
					<span class="i-ph-share-network text-xs" />
