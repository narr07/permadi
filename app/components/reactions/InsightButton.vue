...
<template>
	...
	>
		...
		<Motion
			...
			class="absolute bottom-full right-0 z-50 mb-3 max-w-[320px] w-full border border-slate-200/90 rounded-2xl bg-white/95 p-4 text-slate-900 shadow-2xl backdrop-blur-2xl dark:border-slate-800/90 dark:bg-slate-900/95 dark:text-slate-100 sm:right-1/2 sm:max-w-[350px] sm:translate-x-1/2"
		>
