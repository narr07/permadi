  ...
  >
    <template #header>
      <div class="justify-between   flex items-center">
        <div
          class="font-mono select-all font-bold dark:text-yellow text-[12px]"
        >
          {{ filename }}
        </div>
    ...
    <code class="bg-permadi-300    ">
      <pre
        :class="$props.class"
        class="-mt-1 sm:-mt-1 md:-mt-1 lg:-mt-1 text-base ring ring-[var(--ui-border)] bg-permadi-800 dark:bg-permadi-900 rounded-t-none bg-opacity-0"
        :style="style"
      ><slot /></pre>
    </code>
  </UCard>
