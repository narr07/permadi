...
const designIcon = ref([
  { title: 'Illustrator', iconName: 'i-logos-adobe-illustrator', url: 'https://illustrator.adobe.com/' },
  { title: 'Photoshop', iconName: 'i-logos-adobe-photoshop', url: 'https://photoshop.adobe.com/' },
                ...
                <div class="flex flex-wrap gap-2 md:gap-4 justify-center">
                  <div v-for="(button, index) in designIcon" :key="index">
                    <UTooltip :text="button.title" placement="bottom" :popper="{ arrow: true }">
                      <UButton
                        class="px-1.5" color="primary" variant="subtle" :to="button.url" target="_blank"
                ...
                <div class="flex flex-wrap gap-2 md:gap-4 justify-center">
                  <div v-for="(techIcon, index) in techIcons" :key="index">
                    <UTooltip :text="techIcon.title" placement="bottom" :popper="{ arrow: true }">
                      <UButton
                        class="px-1.5" color="primary" variant="subtle" :to="techIcon.url" target="_blank"
