	...
	<div class="w-full">
		...
		>
			<div class="swiss-container h-full">
				<div class="grid grid-cols-12 h-full gap-4 opacity-15 sm:gap-6 dark:opacity-20">
					<div
						v-for="col in 12"
						:key="col"
			...
			<div class="pointer-events-auto fixed bottom-4 left-4 z-50 border border-brand-500 bg-slate-950 px-3 py-1.5 text-[11px] text-brand-400 font-bold tracking-widest font-mono uppercase shadow-lg">
